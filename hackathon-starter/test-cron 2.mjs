...
const DUFFEL_TOKEN = 'duffel_test_BwM4oghjQEbwFae9z8hMQYDT_txcjf-wPRlwmnwTWBL'
const SUPABASE_URL = 'https://ctklqcaajphsxmvwxdeg.supabase.co/'
const SUPABASE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImN0a2xxY2FhanBoc3htdnd4ZGVnIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzQ2ODkxOTYsImV4cCI6MjA5MDI2NTE5Nn0.hI5ZhvM9r-08uERqFvPV-z1nuYFgJZXP9Oa4gpfDzUY'

const duffel = new Duffel({ token: DUFFEL_TOKEN })
const supabase = createClient(SUPABASE_URL, SUPABASE_KEY)

const ORIGINS = ['LHR', 'BRS']
const DESTINATIONS = ['BKK', 'CDG', 'JFK']
