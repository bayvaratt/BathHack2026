...
export default function App() {
  ...
  async function handleEmailSubmit(event) {
    ...
    try {
      ...
      setEmailResult({
        type: "success",
        message: `Test email sent successfully. Check your inbox for the ${
          data.destination ?? "featured"
        } deal.`,
      });
      setEmail("");
    } catch (error) {
  ...
  async function handleWhatsAppSubmit(event) {
    ...
    try {
      ...
      setWhatsAppResult({
        type: "success",
        message: `Test WhatsApp message sent successfully. Check the phone linked to ${phoneNumber} for the ${
          data.destination ?? "featured"
        } deal.`,
      });
      setPhoneNumber("");
        ...
        <section className="flex-1 rounded-[2rem] border border-stone-300/70 bg-white/80 p-8 shadow-[0_20px_80px_rgba(120,83,34,0.12)] backdrop-blur">
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-3">
            <div className="rounded-2xl bg-stone-100 p-4">
              <div className="text-sm font-medium text-stone-500">Destination</div>
        ...
        <div className="flex w-full max-w-xl flex-col gap-6">
          ...
          <section className="rounded-[2rem] bg-emerald-950 p-8 text-emerald-50 shadow-[0_20px_80px_rgba(6,78,59,0.24)]">
            ...
            <p className="mt-4 text-base leading-7 text-emerald-100/80">
              ...
              <span className="font-medium text-emerald-100"> +447700900123</span>.
            ...
            <form className="mt-8 space-y-5" onSubmit={handleWhatsAppSubmit}>
              ...
              >
                {isSendingWhatsApp ? "Sending test WhatsApp..." : "Send test WhatsApp"}
              </button>
            </form>
