...
export function getDealSummary(deal: Deal) {
  return `${deal.destination_city} is currently ${deal.discountPercent}% below its usual fare from ${deal.origin_iata}.`;
}

export function buildEmailHTML(deals: DealWithSummary[]) {
  ...
  return `
    <div style="font-family:Arial,sans-serif; max-width:560px; margin:0 auto; padding:24px;">
      ...
      <p style="color:#6b7280;">
        Deals from your nearest airport in the next 7 days
      </p>
      ${dealBlocks}
